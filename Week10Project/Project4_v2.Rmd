...
text_classifier <- naiveBayes(text_train, train_labels)

#Make predictions on test set
text_test_pred <- predict(text_classifier, text_test)

#Create confusion matrix
confusionMatrix(data = text_test_pred, reference = test_labels,
                positive = "spam", dnn = c("Prediction", "Actual"))

```

The results above show that the model has a high accuracy.
